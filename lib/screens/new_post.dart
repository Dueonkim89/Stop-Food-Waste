        ...
        child: SingleChildScrollView(
          ...
          Padding(
            ...
            child: Semantics(
                enabled: true,
                textField: true,
                onTapHint: "Enter the quantity of wasted food",
                label: "Form field to enter number of wasted food",
                child: TextFormField(
                  autofocus: true,
          ...
          Padding(
            ...
            child: Semantics(
                ...
                enabled: true,
                label:
                    "Button to upload details of wasted food to application.",
                onTapHint: 'Upload food waste details',
